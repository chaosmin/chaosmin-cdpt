...
import tech.chaosmin.framework.module.payment.api.WechatPayAPI
 ...
 */
@RestController
open class WechatPayProvider(private val wechatpayNativePayService: WechatNativePayService) : WechatPayAPI {
    private val logger = LoggerFactory.getLogger(WechatPayAPI::class.java)
