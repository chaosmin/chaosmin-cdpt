...
import tech.chaosmin.framework.module.mgmt.api.RoleAPI
...
import tech.chaosmin.framework.module.mgmt.logic.interrogator.RoleInterrogator
import tech.chaosmin.framework.utils.RequestUtil
import javax.servlet.http.HttpServletRequest

@RestController
open class RoleProvider(
    private val roleInterrogator: RoleInterrogator,
    private val modifyRoleHandler: ModifyRoleHandler
) : RoleAPI {
    override fun fetchAuthorityOfRole(id: Long): RestResult<List<Long>> {
        val responseData = roleInterrogator.fetchAuthority(id)
        return RestResultExt.successRestResult(responseData)
    }

    override fun selectById(id: Long): RestResult<RoleResp> {
        val role = roleInterrogator.getOne(id)
    ...
    override fun page(request: HttpServletRequest): RestResult<IPage<RoleResp>> {
        ...
        val page = roleInterrogator.page(queryCondition)
