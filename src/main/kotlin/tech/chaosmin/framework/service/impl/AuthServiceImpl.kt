...
//    override fun authenticate(username: String, password: String): UsernamePasswordAuthenticationToken {
//        authenticateService.authenticate(username, password)
//        return tokenService.create(username)
//    }
//
//    @Throws(AuthenticationException::class)
//    override fun authenticateByToken(token: String): UsernamePasswordAuthenticationToken = tokenService.check(token)
//
//    @Throws(AuthenticationException::class)
//    override fun authenticateByAnonymous(): UsernamePasswordAuthenticationToken {
//        if (globalAnonymous) {
...
//    }
//
//    override fun authorize(authentication: UsernamePasswordAuthenticationToken): Predicate<Action> {
