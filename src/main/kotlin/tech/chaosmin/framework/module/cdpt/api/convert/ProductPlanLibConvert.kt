 ...
 */
@Mapper
interface ProductPlanLibConvert : IConvert<ProductPlanLibEntity, ProductPlanLibReq, ProductPlanLibResp> {
    companion object {
        val INSTANCE: ProductPlanLibConvert = Mappers.getMapper(ProductPlanLibConvert::class.java)
    }
}