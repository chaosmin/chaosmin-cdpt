 ...
 */
@Component
class GoodsPlanQueryLogic(private val goodsPlanService: GoodsPlanService) : BaseQueryLogic<GoodsPlanEntity, GoodsPlan> {

    override fun get(id: Long): GoodsPlanEntity? {
        val goodsPlan = goodsPlanService.getById(id)
        return if (goodsPlan == null) null
        else GoodsPlanMapper.INSTANCE.convert2Entity(goodsPlan)
    }
